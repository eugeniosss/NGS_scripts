...
#if not os.path.isfile(snakemake.output.collapsed_trunc):
#    shell("touch {snakemake.output.collapsed_trunc}")


#if not os.path.isfile(snakemake.output.singleton):
#    shell("touch {snakemake.output.singleton")
